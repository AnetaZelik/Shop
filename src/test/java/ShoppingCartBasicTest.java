...
public class ShoppingCartBasicTest {
    ...
    Product sampleProduct = TestFactory.anOffer("offer-1", 10, Collections.emptyList(), Duration.ZERO);
    ...
    public void shouldAddExtraServiceToOffer() {
        ...
        Product productWithService = TestFactory.anOffer("offer-1", 10, Collections.singletonList(service), Duration.ZERO);
    ...
    public void shouldAddTwoExtraServicesToOffer() {
        ...
        Product productWithService = TestFactory.anOffer("offer-1", 10, Arrays.asList(giftPackaging, assemblyService), Duration.ZERO);
        cart.addProduct(productWithService, 1);
